...
public class TestDatabase {
    ...
    public bool GetMaxAge(string email)
    {
        ...
        int maxAge = database.GetMaxAge(email);
        return maxAge != 0;
    ...
    [TestCase("s168742@student.windesheim.nl", "s1167487@student.windesheim.nl", ExpectedResult = true)]
    [TestCase("s1167487@student.windesheim.nl", "s168742@student.windesheim.nl", ExpectedResult = true)]
    ...
    public bool GetPictureFromDatabase(string email)
    {
        try
        {
            ...
            if (picture[0] != null)
            { //check of er een foto in de array zit doormiddel van het checken van de eerste optie
                return true;
            }
        }
        catch
